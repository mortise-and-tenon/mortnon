...
import fun.mortnon.mortnon.framework.properties.MortnonProperties;
import fun.mortnon.mortnon.framework.web.MortnonContextHolder;
...
@MapperScan("fun.mortnon.mortnon.**.mapper")
